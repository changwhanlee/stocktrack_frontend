      ...
      <Box maxWidth="1200px" margin="auto" px={4}>
        <VStack spacing={16}>
          ...
          <Box textAlign="center" maxWidth="800px">
            <Heading as="h1" size="2xl" mb={4} color={highlightColor}>
              자산을 체계적으로 관리해보세요!
            </Heading>
          ...
          {/* Feature Grid */}
          <Grid templateColumns={{ base: "repeat(1, 1fr)", md: "repeat(2, 1fr)" }} gap={8} w="100%">
            {/* Bar Chart Feature */}
              ...
              <Box bg={cardBgColor} p={6} borderRadius="lg" boxShadow="md">
                ...
                <ResponsiveContainer width="100%" height={400}>
                    <LineChart data={barChartData}>
                        ...
                        <Line type="monotone" dataKey="올웨더" stroke="#d81f1e" dot={false} strokeWidth={3} />
                        <Line type="monotone" dataKey="영구포트폴리오" stroke="#d7d81e" dot={false} strokeWidth={3} />
                        <Line type="monotone" dataKey="예금" stroke="#7ad81e" dot={false} strokeWidth={3} />
                        <Line type="monotone" dataKey="개별주식" stroke="#d81ed7" dot={false} strokeWidth={3} />
                    </LineChart>
                </ResponsiveContainer>
                  ...
                  <Table variant="simple">
                    <Thead>
                      <Tr>
                        ...
                        <Th fontSize="lg" fontWeight="semibold" color="gray.700" py={3}>주식 수</Th>
                        <Th fontSize="lg" fontWeight="semibold" color="gray.700" py={3} isNumeric>총 자산가치</Th>
          ...
          {/* Additional Features */}
          <Grid templateColumns={{ base: "repeat(1, 1fr)", md: "repeat(2, 1fr)", lg: "repeat(4, 1fr)" }} gap={8} w="100%">
            <GridItem>
              <FeatureCard
                icon={FaChartLine}
                title="실시간 분석"
